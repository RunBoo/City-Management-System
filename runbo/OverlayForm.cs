...
namespace runbo
{
    public partial class OverlayForm : Form
    {
        ...
        public OverlayForm(object hook)
        {
            InitializeComponent();
        }
        ...
        private void OverlayForm_Load(object sender, EventArgs e)
        {
            ...
            //this.cboOverLay.Items.Add("擦除(Clip)");
        ...
        private void btnOverlay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (strOverlay)
                {
                    ...
                    //    //设置输入要素
                    //    clipTool.in_features = pObject;
                    //    //设置输出路径
                    //    strOutputPath += strName + "_" + "_clip.shp";
                    //    clipTool.out_feature_class = strOutputPath;
                    //    //执行联合运算
                    //    result = gp.Execute(clipTool, null) as IGeoProcessorResult;
                    //    break;
                    //case "标识(Identity)":
